...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .timeline-item:hover { transform: translateY(-3px); text-decoration: none; }
    ...
    [data-theme="light"] .timeline-item .tl-dot { border-color: var(--bg); }
    .timeline-item:hover .tl-dot { transform: scale(1.3); box-shadow: 0 0 0 3px var(--amber), 0 0 12px rgba(245,158,11,0.3); }
    ...
    @media (max-width: 640px) {
      .timeline { padding-bottom: 0.5rem; }
...
// --- 1. index.html — Research document (all sections combined) ---
{
  ...
  let body = `
    ...
    <div class="timeline">
      ...
      <div class="timeline-item"><a href="#intellectual-contributions"><span class="tl-dot" style="background: var(--green)"></span><span class="tl-year">2015</span><span class="tl-title">Co-founds OpenAI</span></a></div>
      <div class="timeline-item"><a href="#intellectual-contributions"><span class="tl-dot" style="background: var(--red)"></span><span class="tl-year">2017</span><span class="tl-title">Tesla AI Director</span></a></div>
      <div class="timeline-item"><a href="#education-and-teaching"><span class="tl-dot" style="background: var(--cyan)"></span><span class="tl-year">2022</span><span class="tl-title">nanoGPT & Teaching</span></a></div>
      <div class="timeline-item"><a href="#intellectual-contributions"><span class="tl-dot" style="background: var(--green)"></span><span class="tl-year">2023</span><span class="tl-title">Returns to OpenAI</span></a></div>
      <div class="timeline-item"><a href="#eureka-labs"><span class="tl-dot" style="background: var(--purple)"></span><span class="tl-year">2024</span><span class="tl-title">Founds Eureka Labs</span></a></div>
    </div>
